...
# Import data
movie_ratings_df = pd.read_csv(r'D:\sofyan\Uas-SPK\matrix-factorization-Predict-SPK-\movie_ratings_data_set.csv')
movies_df = pd.read_csv(r'D:\sofyan\Uas-SPK\matrix-factorization-Predict-SPK-\movies.csv', index_col='movie_id')
